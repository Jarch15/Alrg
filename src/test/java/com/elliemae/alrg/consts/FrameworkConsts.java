...
public final class FrameworkConsts {
	...
	public static String NETWORKUSERPASSWORD = "Jenkins@12345$";
	...
	public static String EMNETWORKUSERPASSWORD = "JenkinsAdmin@123$";
	
	// *****************************************
	// JIRA User
	// *****************************************	
	public static String JIRAUSERNAME = "jiraATFUser";
	public static String JIRAUSERPASSWORD = "jiraATFUser";
